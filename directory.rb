...
def print_menu
  ...
  puts "4. Load the lst from students.csv"
  puts "9. Exit"
end
...
def load_students(filename = "students.csv")
  ...
  file.readlines.each {
    |line|
    name, date_of_birth, hobby, cohort = line.chomp.split(',')
    @students << {name: name, date_of_birth: date_of_birth, hobby: hobby, cohort: cohort.to_sym}
  }
  file.close
end
